...
class MultipleQuestionPoll extends StatefulWidget {
  final EntityModel entity;
  final ProcessModel process;
  final ScrollController scaffoldScrollController;
  final GlobalKey voteButtonKey;

  MultipleQuestionPoll(this.entity, this.process, this.scaffoldScrollController,
      this.voteButtonKey);

  @override
  _MultipleQuestionPollState createState() => _MultipleQuestionPollState();
}

class _MultipleQuestionPollState extends State<MultipleQuestionPoll> {
  List<int> choices = [];
