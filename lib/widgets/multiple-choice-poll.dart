...
class MultipleChoicePoll extends StatefulWidget {
  final EntityModel entity;
  final ProcessModel process;
  final ScrollController scaffoldScrollController;
  final GlobalKey voteButtonKey;

  MultipleChoicePoll(this.entity, this.process, this.scaffoldScrollController,
      this.voteButtonKey);

  @override
  _MultipleChoicePollState createState() => _MultipleChoicePollState();
}

class _MultipleChoicePollState extends State<MultipleChoicePoll> {
  List<int> choices = [];
  int get numSelected =>
      choices.where((element) => element > 0).toList().length;
