...
//             identity.keys[0].encryptedRootPrivateKey;
...
//           return respondError(
//               id, "The pattern entered by the user is not valid");
//         }

//         String privateKey = await Symmetric.decryptStringAsync(
//             encryptedRootPrivateKey, patternStr);
