...
final double opacityBackgroundColor = 0.15;

final Color colorMainBackground = Color(0xFF548CFF);
final Color colorAltBackground = Color(0xFFE4534D);
final Color colorAlt2Background = Color(0xFFFF682D);

final Color colorMainText = Color(0xFFFFFFFF); // white

final colorSuccess = Color(0xFF25bd5b);
final colorDanger = colorAltBackground;
...
final Color colorLightGuide = Color(0x66888888);
