...
The project makes use of the [DVote Flutter](https://pub.dev/packages/dvote) plugin. Please, refer to [GitHub](https://github.com/vocdoni/dvote-flutter) for more details. 